...
const newOuterRadius = radius * 1.2;
...
const arcPaths = svg.selectAll(".arc")
    ...
    .on("click", function(event, d) {
        ...
        // Append path and text to each outer arc group
        outerArcs.append("path")
            .attr("class", "outerArcPath")
            .attr("d", arcLabel)
            .style("opacity", 0)
            .transition()
            .duration(1000)
...
const legend = svg.selectAll(".legend")
    ...
    .append("g")
    .attr("class", "legend")
    .attr("transform", (d, i) => `translate(45,${i * 25- height / 2 + 100})`);
